...
def set_login_credentials(profile):
    ...
    # print(f'\n{profile["profile_name"]} tenant_id set as: {os.environ.get("AZURE_TENANT_ID")}')

    # configure = subprocess.Popen(['aws-azure-login', '--configure', '--profile', profile["profile_name"]], shell=True)
    # configure.wait()
